...
var (
	...
	flag32                   = flag.String("32", "386,32bit,win32", "When anyone of the specified strings is found in the zipfile's name, judge its architecture is 32bit")
	flag64                   = flag.String("64", "amd64,64bit,win64", "When anyone of the specified strings is found in the zipfile's name, judge its architecture is 64bit")
